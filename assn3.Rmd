...
required_packages <- c("DESeq2", "readr", "magrittr", "ggplot2", "dplyr", "ConsensusClusterPlus", "cluster", "factoextra", "pheatmap")
...
fviz_cluster(PAM_cluster_3, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 3")
dev.off()
fviz_cluster(PAM_cluster_3, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 3")
...
fviz_cluster(PAM_cluster_5, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 5")
dev.off()
fviz_cluster(PAM_cluster_5, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 5")
...
fviz_cluster(PAM_cluster_10, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 10")
dev.off()
fviz_cluster(PAM_cluster_10, data = top_5000_genes_mads_matrix, geom="point", main="PAM Clustering for k = 10")
...
PAM_cluster <- pam(top_10_genes_mads_matrix, 5, metric="euclidean", stand=FALSE)
fviz_cluster(PAM_cluster, data = top_10_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 10 Genes and k = 5")
dev.off()
fviz_cluster(PAM_cluster, data = top_10_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 10 Genes and k = 5")
...
PAM_cluster <- pam(top_100_genes_mads_matrix, 5, metric="euclidean", stand=FALSE)
fviz_cluster(PAM_cluster, data = top_100_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 100 Genes and k = 5")
dev.off()
fviz_cluster(PAM_cluster, data = top_100_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 100 Genes and k = 5")
...
PAM_cluster <- pam(top_1000_genes_mads_matrix, 5, metric="euclidean", stand=FALSE)
fviz_cluster(PAM_cluster, data = top_1000_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 1000 Genes and k = 5")
dev.off()
fviz_cluster(PAM_cluster, data = top_1000_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 1000 Genes and k = 5")
...
PAM_cluster <- pam(top_10000_genes_mads_matrix, 5, metric="euclidean", stand=FALSE)
fviz_cluster(PAM_cluster, data = top_10000_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 10000 Genes and k = 5")
dev.off()
fviz_cluster(PAM_cluster, data = top_10000_genes_mads_matrix, geom="point", 
             main="PAM Clustering for 10000 Genes and k = 5")
